...
VertexOutputForwardBase vertForwardBase (VertexInput v)
{
	...
	//Beast
		...
		o.bData = float4(UnityObjectToWorldNormal(v.normal), 1);
	#elif defined(DEBUG_TANGENT) && defined(_TANGENT_TO_WORLD)
		o.bData = float4(UnityObjectToWorldDir(v.tangent.xyz), 1);
	#else
		o.bData = 0;
	#endif
...
{
	//Beast
	#if defined(DEBUG_NORMAL) || defined(DEBUG_TANGENT)
		return i.bData;
	#endif
